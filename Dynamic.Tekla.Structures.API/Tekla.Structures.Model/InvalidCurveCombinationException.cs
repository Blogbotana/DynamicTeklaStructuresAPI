...
public  class InvalidCurveCombinationException  : LoftedPlateOperationException
{
		...
		{
			teklaObject = TSActivator.CreateInstance("Tekla.Structures.Model.InvalidCurveCombinationException");
		}
...
internal static class InvalidCurveCombinationException_
{
    ...
    public static InvalidCurveCombinationException FromTSObject(dynamic tsObject)
    {
        ...
        var dynObject = (InvalidCurveCombinationException)System.Activator.CreateInstance(type, parameters);
