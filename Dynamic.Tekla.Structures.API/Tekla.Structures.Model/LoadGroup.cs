...
public  class LoadGroup  : ModelObject
    {
        ...
        public LoadGroup.LoadGroupType GroupType
        {
            get
            {
                try
                ...
                var value_ = LoadGroup.LoadGroupType_.FromTSObject(value);
                return (LoadGroup.LoadGroupType) value_;
                }
                catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
                {
            ...
            set
            {
                try
                {
                var value_ = LoadGroup.LoadGroupType_.GetTSObject(value);
        ...
        public LoadGroup.LoadGroupDirection Direction
        {
            get
            {
                try
                ...
                var value_ = LoadGroup.LoadGroupDirection_.FromTSObject(value);
                return (LoadGroup.LoadGroupDirection) value_;
                }
                catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
                {
            ...
            set
            {
                try
                {
                var value_ = LoadGroup.LoadGroupDirection_.GetTSObject(value);
        ...
        public LoadGroup.Colors Color
        {
            get
            {
                ...
                var value_ = LoadGroup.Colors_.FromTSObject(value);
                return (LoadGroup.Colors) value_;
                }
                catch (Microsoft.CSharp.RuntimeBinder.RuntimeBinderException ex)
                {
            ...
            set
            {
                try
                {
                var value_ = LoadGroup.Colors_.GetTSObject(value);
	...
	public LoadGroup()
	{
		teklaObject = TSActivator.CreateInstance("Tekla.Structures.Model.LoadGroup");
	}
    ...
    internal static class LoadGroup_
    {
        ...
        public static LoadGroup FromTSObject(dynamic tsObject)
        {
            ...
            var dynObject = (LoadGroup)System.Activator.CreateInstance(type, parameters);
