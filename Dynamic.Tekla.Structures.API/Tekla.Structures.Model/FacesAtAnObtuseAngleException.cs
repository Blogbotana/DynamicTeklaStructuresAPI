...
public  class FacesAtAnObtuseAngleException  : ConnectiveGeometryException
{
		...
		{
			teklaObject = TSActivator.CreateInstance("Tekla.Structures.Model.FacesAtAnObtuseAngleException");
		}
...
internal static class FacesAtAnObtuseAngleException_
{
    ...
    public static FacesAtAnObtuseAngleException FromTSObject(dynamic tsObject)
    {
        ...
        var dynObject = (FacesAtAnObtuseAngleException)System.Activator.CreateInstance(type, parameters);
