...
public  class FacesTooNearEachOtherException  : ConnectiveGeometryException
{
		...
		{
			teklaObject = TSActivator.CreateInstance("Tekla.Structures.Model.FacesTooNearEachOtherException");
		}
...
internal static class FacesTooNearEachOtherException_
{
    ...
    public static FacesTooNearEachOtherException FromTSObject(dynamic tsObject)
    {
        ...
        var dynObject = (FacesTooNearEachOtherException)System.Activator.CreateInstance(type, parameters);
